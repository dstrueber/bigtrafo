 ...
 * <ul>
 *   <li>{@link GraphConstraint.impl.GraphElementImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class GraphElementImpl extends MinimalEObjectImpl.Container implements GraphElement {
	...
	protected EClass eStaticClass() {
		return GraphConstraintPackage.Literals.GRAPH_ELEMENT;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GraphConstraintPackage.GRAPH_ELEMENT__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case GraphConstraintPackage.GRAPH_ELEMENT__NAME:
				return getName();
		}
