...
/**
 * This is the item provider adapter for a {@link de.imotep.featuremodel.variability.metamodel.FeatureModel.FeatureModel} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FeatureModelItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(FeatureModelPackage.Literals.FEATURE_MODEL__COMMENTS);
			...
			childrenFeatures.add(FeatureModelPackage.Literals.FEATURE_MODEL__GROUPS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(FeatureModelPackage.Literals.FEATURE_MODEL__COMMENTS,
				 FeatureModelFactory.eINSTANCE.createComment()));

		newChildDescriptors.add
			(createChildParameter
				(FeatureModelPackage.Literals.FEATURE_MODEL__CONSTRAINTS,
				 FeatureModelFactory.eINSTANCE.createRequireConstraint()));

		newChildDescriptors.add
			(createChildParameter
				(FeatureModelPackage.Literals.FEATURE_MODEL__CONSTRAINTS,
				 FeatureModelFactory.eINSTANCE.createExcludeConstraint()));
		...
		newChildDescriptors.add
			(createChildParameter
				(FeatureModelPackage.Literals.FEATURE_MODEL__GROUPS,
