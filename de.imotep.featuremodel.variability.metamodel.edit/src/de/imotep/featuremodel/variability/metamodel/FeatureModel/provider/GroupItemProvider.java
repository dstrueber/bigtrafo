...
/**
 * This is the item provider adapter for a {@link de.imotep.featuremodel.variability.metamodel.FeatureModel.Group} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Group_features_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Group_features_feature", "_UI_Group_type"),
	...
	protected void addGroupTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Group_groupType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Group_groupType_feature", "_UI_Group_type"),
				 FeatureModelPackage.Literals.GROUP__GROUP_TYPE,
				 true,
				 false,
				 false,
