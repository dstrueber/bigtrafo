...
/**
 * This is the item provider adapter for a {@link de.imotep.featuremodel.variability.metamodel.FeatureModel.Comment} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Comment_element_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Comment_element_feature", "_UI_Comment_type"),
				 FeatureModelPackage.Literals.COMMENT__ELEMENT,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 FeatureModelPackage.Literals.COMMENT__TEXT,
				 true,
				 false,
				 false,
